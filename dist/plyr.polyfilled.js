typeof navigator === "object" && (function (global, factory) {
  ...
  function loadSprite(url, containerId) {
    const hasId = is.string(containerId);
    ...
    symbols.forEach(({
      ...
      paths.forEach(({
        ...
        if (fillOpacity) {
          path.setAttributeNS(null, 'fillOpacity', fillOpacity);
        }
        if (fillRule) {
          path.setAttributeNS(null, 'fillRule', fillRule);
        }
